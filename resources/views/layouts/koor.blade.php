...
<body x-data="{ sidebarOpen: false }" class="bg-gray-100 h-screen overflow-hidden flex">
    ...
    <aside
        ...
        <nav class="flex-1 overflow-y-auto px-2 space-y-2 scrollbar-custom">
            <a href="{{ route('dashboard.koor') }}" class="block p-2 rounded hover:bg-blue-700">Dashboard</a>
            <a href="{{ route('absen.scan') }}" class="block p-2 rounded hover:bg-blue-700">Scan Absen</a>
            <a href="{{ route('bidang.koor.index', ['bidang' => auth()->user()->mahasiswa->peminatan]) }}"
                class="block p-2 rounded hover:bg-blue-700">List Mahasiswa</a>
            <a href="{{ route('modul.index') }}" class="block p-2 rounded hover:bg-blue-700">List Modul</a>
            <a href="{{ route('modul.create') }}" class="block p-2 rounded hover:bg-blue-700">Upload Modul</a>
